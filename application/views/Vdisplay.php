  ...
  <div class="row">
    ...
    <div class="col-lg-8 col-xl-8 mb-lg-2 mx-xl-auto text-center">
       <div class="card bg-warning">
        <div class="card-body">          
          <h1 class="text-center">Aplikasi Antrian Ditlantas Polda Kalteng</h1>
        <?php echo date('l').' '.date('d F Y').' '.date('H:m:i');?>
        </div>
      </div>
      <div class="card text-center bg-white">
        <div class="card-body mt-0 mb-0 p-0">
      <video id="myvideo" src="<?php echo base_url();?>assets/video/ETLE di Kalteng Tidak lama Lagi.mp4" width="80%" muted controls></video>
      </div>
      </div>
    </div>
  </div>
...
<script>
  $(function() {
    ...
    var myvids = [
      "<?php echo base_url();?>assets/video/ETLE di Kalteng Tidak lama Lagi.mp4", 
      "<?php echo base_url();?>assets/video/Info Sinar Part 1 - Ditlantas Polda Kalteng.mp4"
      ];
    var activeVideo = 0;
    myvid.play();
